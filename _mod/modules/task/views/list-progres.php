<div class='table-responsive'>
    ...
    <span class="btn bg-primary-400 btn-labeled btn-labeled-right legitRipple pull-right" data-id="<?=$aktifitas_mitigas['id'];?>" id="add_progres" id="add_mitigasi"><b><i class="icon-file-plus "></i></b> <?=_l('fld_add_progres_mitigasi');?></span>
    <br/>&nbsp;<br/>&nbsp;
