...
class Position extends MY_Controller
{
	...
	{
		$this->kelompok_id = 'jabatan';
		$this->set_Tbl_Master( _TBL_COMBO );

		$this->addField( [ 'field' => 'id', 'type' => 'int', 'show' => FALSE, 'size' => 4 ] );
		$this->addField( [ 'field' => 'data', 'title' => 'Position', 'required' => TRUE, 'search' => TRUE, 'size' => 100 ] );
		...
		if( _MODE_ == 'add' )
		{
			$content_title = 'Penambahan Position/Jabatan';
		}
		elseif( _MODE_ == 'edit' )
		{
			$content_title = 'Perubahan Position/Jabatan';
		}
		else
		{
			$content_title = 'Daftar Position/Jabatan';
		}
