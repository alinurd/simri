...
class Type_Kri extends MY_Controller
{
	...
	function init( $action = 'list' )
	{
		...
		if( _MODE_ == 'add' )
		{
			$content_title = 'Penambahan Jenis KRI';
		}
		elseif( _MODE_ == 'edit' )
		{
			$content_title = 'Perubahan Jenis KRI';
		}
		else
		{
			$content_title = 'Daftar Jenis KRI';
		}
