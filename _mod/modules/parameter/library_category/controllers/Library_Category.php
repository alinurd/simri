...
class Library_Category extends MY_Controller {
	...
	function init($action='list'){
		...
		$this->addField(['field'=>'data', 'title'=>'Library Category', 'required'=>true, 'search'=>true, 'size'=>100]);
		...
		if (_MODE_=='add') {
			$content_title = 'Penambahan Klasifikasi Risiko';
		}elseif(_MODE_=='edit'){
			$content_title = 'Perubahan Klasifikasi Risiko';
		}else{
			$content_title = 'Daftar Klasifikasi Risiko';
		}
