<table class="table table-hover table-striped table-sm" id="tbl_term">
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right"><?=form_dropdown('term[]', $owner,$key,'class="form-control select2"');?></td>
...
<hr><span class="btn btn-info float-right pointer" id="add_term"> Add KRI </span><br/>
