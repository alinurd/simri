<table class="table table-hover table-striped table-sm" id="tbl_term">
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right"><?=form_input('param_date[]',$row['param_date'],'class="form-control pickadate"');?></td>
            <td class="text-right"><?=form_input('param_date_after[]',$row['param_date_after'],'class="form-control pickadate"');?></td>
