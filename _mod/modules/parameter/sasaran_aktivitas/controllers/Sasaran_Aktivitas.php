...
class Sasaran_Aktivitas extends MY_Controller
{
	...
	{
		$this->kelompok_id = 'sasaran-aktivitas';
		$this->cboDept     = $this->get_combo_parent_dept();

		$this->set_Tbl_Master( _TBL_COMBO );

		$this->addField( [ 'field' => 'id', 'type' => 'int', 'show' => FALSE, 'size' => 4 ] );
		$this->addField( [ 'field' => 'pid', 'title' => 'Department', 'type' => 'int', 'required' => TRUE, 'input' => 'combo', 'search' => TRUE, 'values' => $this->cboDept ] );
		$this->addField( [ 'field' => 'data', 'title' => 'Sasaran Aktivitas', 'input' => 'multitext', 'required' => TRUE, 'search' => TRUE, 'size' => 500 ] );
		...
		if( _MODE_ == 'add' )
		{
			$content_title = 'Penambahan Sasaran Aktivitas';
		}
		elseif( _MODE_ == 'edit' )
		{
			$content_title = 'Perubahan Sasaran Aktivitas';
		}
		else
		{
			$content_title = 'Daftar Sasaran Aktivitas';
		}
