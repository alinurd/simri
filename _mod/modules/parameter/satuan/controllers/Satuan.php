...
class Satuan extends MY_Controller
{
	...
	{
		$this->kelompok_id = 'satuan';
		$this->set_Tbl_Master( _TBL_COMBO );

		$this->addField( [ 'field' => 'id', 'type' => 'int', 'show' => FALSE, 'size' => 4 ] );
		$this->addField( [ 'field' => 'data', 'title' => 'Satuan', 'required' => TRUE, 'search' => TRUE, 'size' => 100 ] );
		...
		if( _MODE_ == 'add' )
		{
			$content_title = 'Penambahan Satuan';
		}
		elseif( _MODE_ == 'edit' )
		{
			$content_title = 'Perubahan Satuan';
		}
		else
		{
			$content_title = 'Daftar Satuan';
		}
