...
class Kelompok_Bisnis extends MY_Controller {
	...
	function init($action='list'){
		$this->kelompok_id='kel-bisnis';
		$this->set_Tbl_Master(_TBL_COMBO);
		
		$this->addField(['field'=>'id', 'type'=>'int', 'show'=>false, 'size'=>4]);
		$this->addField(['field'=>'data', 'title'=>'Kelompok Bisnis', 'required'=>true, 'search'=>true, 'size'=>100]);
		...
		if (_MODE_=='add') {
			$content_title = 'Penambahan Kelompok Bisnis';
		}elseif(_MODE_=='edit'){
			$content_title = 'Perubahan Kelompok Bisnis';
		}else{
			$content_title = 'Daftar Kelompok Bisnis';
		}
