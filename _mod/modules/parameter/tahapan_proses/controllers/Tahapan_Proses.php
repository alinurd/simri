...
class Tahapan_Proses extends MY_Controller {
	...
	function init($action='list'){
		$this->kelompok_id='tahapan-proses';
		$this->set_Tbl_Master(_TBL_COMBO);

		$this->addField(['field'=>'id', 'type'=>'int', 'show'=>false, 'size'=>4]);
		$this->addField(['field'=>'data', 'title'=>'Tahapan Proses', 'required'=>true, 'search'=>true, 'size'=>100]);
		...
		if (_MODE_=='add') {
			$content_title = 'Penambahan Tahapan Proses';
		}elseif(_MODE_=='edit'){
			$content_title = 'Perubahan Tahapan Proses';
		}else{
			$content_title = 'Daftar Tahapan Proses';
		}
