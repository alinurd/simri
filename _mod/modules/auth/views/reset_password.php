				...
				<div class="card mb-0">
					<div class="card-body">
						<center>
							...
							<span class="d-block text-muted">Hallo <?php echo $maskedName; ?> <br> Please enter your new
								password</span>
						...
						<div class="form-group form-group-feedback form-group-feedback-right">
							<input type="<?= $new_password['type'] ?>" name="<?= $new_password['name'] ?>"
								pattern="<?= $new_password['pattern'] ?>" id="<?= $new_password['id'] ?>"
						...
						<div class="form-group form-group-feedback form-group-feedback-right">
							<input type="<?= $new_password_confirm['type'] ?>"
								name="<?= $new_password_confirm['name'] ?>"
								pattern="<?= $new_password_confirm['pattern'] ?>"
								id="<?= $new_password_confirm['id'] ?>" class="form-control"
						...
						<br />
						<button type="submit" id="submit_buttonx" class="btn btn-primary "
							disabled><?php echo lang( 'reset_password_submit_btn' ); ?></button><br>
					</div>
				</div>
				<?php echo form_close(); ?>
				<!-- /unlock form -->
