...
<div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <h6>Inherent&nbsp;<span class="badge badge-secondary text-center">
                        <?= ! empty( $jml_inherent ) ? $jml_inherent : 0; ?></span>
                </h6>
                <?= $map_inherent ?>
            </div>
        </div>
    ...
    <div class="col-md-4 text-center">
        <div class="row">
            <div class="col-md-12">
                <h6>Current&nbsp;<span class="badge badge-secondary text-center">
                        <?= ! empty( $jml_residual ) ? $jml_residual : 0; ?></span>
                </h6>
                <?= $map_residual ?>
            </div>
        </div>
    ...
    <div class="col-md-4 text-center">
        <div class="row">
            <div class="col-md-12">
                <h6>Residual&nbsp;<span class="badge badge-secondary text-center">
                        <?= ! empty( $jml_target ) ? $jml_target : 0; ?></span>
                </h6>
                <?= $map_target ?>
            </div>
        </div>
