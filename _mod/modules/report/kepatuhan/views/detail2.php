...
<strong>Kepatuhan Pelaporan Monitoring Manajement Risiko Korporasi</strong><br>
    ...
    <?php if(count($proyek_all)>0):?>
        ...
        <?php foreach($proyek_all as $row):?>
            <?php 
                                ...
                                foreach ($co['proyek_all'] as $p => $q) {
                                    ...
                                    if ($q['bk1'] == '1') {
                                        if (isset($q[0]['tgl_propose'])) {
                                            ...
                                            $diffx = kepatuhan2($nilai_diffx)."%";
                                            $kepatuhanx += kepatuhan2($nilai_diffx);
                                        }
                ...
                if ($row['bk3_before'] == '1') {
                    ...
                    if (isset($row[1]['tgl_propose_bk3'])) {
                        ...
                        if ($divisi==-1) {
                                ...
                                foreach ($co_before['proyek_all'] as $pb => $qb) {
                                    ...
                                    if ($qb['bk3_before'] == '1') {
                                        if (isset($qb[1]['tgl_propose_bk3'])) {
                                            ...
                                            $diff_beforex = kepatuhan2($nilai_diff_beforex)."%";
                                            $kepatuhan_beforex += kepatuhan2($nilai_diff_beforex);
                                        }
                            ...
                            $diff_before = kepatuhan2($nilai_diff_before)."%";
                            $kepatuhan_before += kepatuhan2($nilai_diff_before);
                        }
                ...
                //                             $diff_lossx = kepatuhan2($nilai_diff_lossx)."%";
                //                             $kepatuhan_lossx += kepatuhan2($nilai_diff_lossx);
                //                         }
                ...
                //             $diff_loss = kepatuhan2($nilai_diff_loss)."%";
                //             $kepatuhan_loss += kepatuhan2($nilai_diff_loss); 
                //         }
                ...
                // if ($row['bkx_loss'] > 0 && $row[0]['id']>0) {
                    ...
                    $dua = (isset($nilai_diff_before))?intval(kepatuhan2($nilai_diff_before)):0;
                    // $tiga = (isset($nilai_diff_loss))?intval(kepatuhan2($nilai_diff_loss)):0;
