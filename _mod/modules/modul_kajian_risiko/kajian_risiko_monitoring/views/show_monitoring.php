                                                                                    ...
                                                                                    <?php if( ! empty( $vReg["monitoring"] ) )
                                                                                    {
                                                                                        ...
                                                                                        {?>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="text-center"><?= (!empty($vMonitoring['tanggal_update'])&& date( "d-m-Y", strtotime( $vMonitoring["tanggal_update"] ) ) != "00-00-0000")?date("Y-m-d",strtotime($vMonitoring['tanggal_update'])):"" ?>
                                                                                                </td>
                                                                                                <td class="text-center">
