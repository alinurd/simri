                    ...
                    foreach ($detail as $row) : ?>
                        ...
                        <?php if ($b == $row['minggu_id']) : ?>
                            ...
                            <tr class="pointer detail-rcsa" data-id="<?= $row['id']; ?>" data-rcsa="<?= $row['rcsa_id']; ?>" data-dampak="<?= $row['impact_residual_id']; ?>">
                                ...
                                <td class="text-center col-prog" style="cursor: default;"><?php// $row['jml3']; ?><br><span class="badge bg-warning-400 badge-pill align-self-center ml-auto pointer progress">Lihat Detail</span></td>

                                <td class="text-center col-prog" style="cursor: default;"><?= $row['avg2'] ?>% <br><span class="badge bg-info-400 badge-pill align-self-center ml-auto pointer ketepatan d-none">Lihat Chart</span></td>
                            </tr>
