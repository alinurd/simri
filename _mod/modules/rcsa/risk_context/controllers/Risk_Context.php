	...
	function identifikasi_content($data = [], $parent = [])
	{
		...
		if ($data) {
			...
			<td style="padding-left:0px;">'
				. form_input('peristiwa_id_text', '', 'class="form-control getPeristiwa " id="peristiwa_id_text" readonly="readonly"  placeholder="' . _l('fld_peristiwa_risiko') . '"')
