        ...
        <div class="col-lg-9">
            <div class ="form-group form-group-feedback form-group-feedback-right">
                ...
                <?php if ($add):
                    ...
                    ?>
                    <div class="form-control-feedback text-primary form-control-feedback-lg pointer manual_combo" data-id="0" data-key="<?=$key;?>" id="add_<?=$key;?>"><i class="icon-file-empty"></i></div>
                <?php endif;?>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-4">
        <span <?=$no_edit;?> class="btn bg-success-400 legitRipple" id="simpan_identifikasi_awal" style="pointer-events:<?=$events;?>"><b><i class="icon-floppy-disk "></i></b> <?=_l('fld_save_identifikasi');?></span>
    </div>
