<div id="entri_mitigasi">
    ...
    foreach($mitigasi as $key=>$row):
        ...
        <?php
    endforeach;?>
    <span class="btn bg-success-400 btn-labeled btn-labeled-right legitRipple pull-right" id="simpan_mitigasi"><b><i class="icon-floppy-disk "></i></b> <?=_l('fld_save_mitigasi');?></span>
    <br/>
    <hr/>
</div>
<script>
