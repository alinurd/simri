            ...
            <div class="card-body">
                <span data-id="<?= $parent['id']; ?>"
                    class="btn bg-primary-400 btn-labeled btn-labeled-left legitRipple" id="back_identifikasi"><b><i
                            class="icon-list"></i></b> <?= _l( 'fld_list_identifikasi' ); ?></span>
                <span data-id="<?= $parent['id']; ?>"
                    class="btn bg-warning-400 btn-labeled btn-labeled-right legitRipple pull-right risk-register"
                    id="risk_register"><b><i class="icon-file-presentation "></i></b>
                    <?= _l( 'fld_risk_register' ); ?></span>
            </div>
        </div>
    </div>
</div>
