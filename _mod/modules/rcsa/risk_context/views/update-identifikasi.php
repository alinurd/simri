...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <span data-id="<?=$parent['id'];?>" class="btn bg-primary-400 btn-labeled btn-labeled-left legitRipple" id="back_identifikasi"><b><i class="icon-list"></i></b> <?=_l('fld_list_identifikasi');?></span>
                <span data-id="<?=$parent['id'];?>" class="btn bg-warning-400 btn-labeled btn-labeled-right legitRipple pull-right risk-register"  id="risk_register"><b><i class="icon-file-presentation "></i></b>  <?=_l('fld_risk_register');?></span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-top">
                    <li class="nav-item">
                        <a href="#content-tab-00" class="nav-link active show" data-toggle="tab"><?=_l('fld_identifikasi_risiko');?></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="content-tab-01">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label text-<?=$this->_preference_['align_label'];?>"><?=$detail['tipe_analisa']['title'].$help;?></label>
                            <div class="col-lg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <span <?=$no_edit;?> class="btn bg-success-400 legitRipple" id="simpan_identifikasi" style="pointer-events:<?=$events;?>"><b><i class="icon-floppy-disk "></i></b> <?=_l('fld_save');?></span>
                            </div>
