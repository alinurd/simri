...
<div class="row">
    <div class="col-lg-4">
        <span <?=$no_edit;?> class="btn bg-success-400 legitRipple" id="simpan_evaluasi"  style="pointer-events:<?=$events;?>"><b><i class="icon-floppy-disk "></i></b> <?=_l('fld_save_evaluasi');?></span>
    </div>
