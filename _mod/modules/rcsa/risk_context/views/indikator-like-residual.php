        ...
        <tbody>
            ...
            foreach($list_like_indi as $row):
                ...
                <tr>
                    ...
                    <td class="pointer">
                        <i class="icon-database-edit2 text-primary-400 update-like-indi-residual" data-parent="<?=$parent;?>" data-id="<?=$row['id'];?>"></i>
                        <i class="icon-database-remove text-danger-400 delete-like-indi" data-parent="<?=$parent;?>" data-id="<?=$row['id'];?>" data-bk="2"></i> </td>
                    </td>
                </tr>
            <?php endforeach;?>
        </tbody>
