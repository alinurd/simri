<div class='table-responsive'>
    ...
    <span class="btn bg-primary-400 btn-labeled btn-labeled-right legitRipple pull-right"
        data-id="<?= $parent['id']; ?>" id="add_aktifitas_mitigasi"><b><i class="icon-file-plus "></i></b>
        <?= _l( 'fld_add_aktifitas_mitigasi' ); ?></span><br />&nbsp;<br />&nbsp;
        ...
        <tbody>
            ...
            foreach( $list_aktifitas as $row ) : ?>
                <tr>
                    ...
                    <td class="pointer">
                        <i class="icon-database-edit2  text-primary-400 update-aktifitas-mitigasi"
                            data-rcsa="<?= $parent['id']; ?>" data-id="<?= $row['id']; ?>"></i> |
                        <i class="icon-database-remove  text-danger-400 delete-aktifitas-mitigasi"
                            data-id="<?= $row['id']; ?>"></i>
                    </td>
                </tr>
            <?php endforeach; ?>
