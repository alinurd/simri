<div class='table-responsive' id="div_like_indi">
    Daftar KPI/KRI
    <span class="btn bg-primary-400 btn-labeled btn-labeled-right legitRipple pull-right " data-parent="<?= $parent; ?>" data-minggu="<?= $minggu; ?>" id="add_kpi"><b><i class="icon-file-plus "></i></b> <?= _l('fld_add_kpi'); ?></span>
    <br />&nbsp;<br />&nbsp;
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?= $row['title']; ?>
                        <span class="btn bg-danger-400 btn-labeled btn-labeled-right legitRipple pull-right btn-sm" data-minggu="<?= $minggu; ?>" data-rcsa="<?= $parent ?>" data-parent="<?= $row['id']; ?>" data-id="0" id="add_kri"><b><i class="icon-file-plus "></i></b> <?= _l('fld_add_kri'); ?></span>
                    </td>
