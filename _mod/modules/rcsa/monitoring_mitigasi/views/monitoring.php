...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <a href="<?=base_url('monitoring-mitigasi');?>" class="btn bg-primary-400 btn-labeled btn-labeled-left legitRipple" id="back_identifikasi"><b><i class="icon-list"></i></b> <?=_l('fld_kembali_list_monitoring');?></a>
            </div>
        </div>
    </div>
</div>
