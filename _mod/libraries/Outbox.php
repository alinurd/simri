		...
		try
		{
			if( $this->_params )
			{
				...
				foreach( $this->_params as $key => $row )
				{
					...
					$this->_datas['message']      = ( ! empty( $this->_datas['message'] ) ) ? str_replace( $key, $row, $this->_datas['message'] ) : "";
					$this->_datas['message_text'] = ( ! empty( $this->_datas['message_text'] ) ) ? str_replace( $key, $row, $this->_datas['message_text'] ) : '';
					$this->_datas['subject']      = ( ! empty( $this->_datas['subject'] ) ) ? str_replace( $key, $row, $this->_datas['subject'] ) : "";
				}
			}
