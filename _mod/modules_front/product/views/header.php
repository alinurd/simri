<div class="card card-body">
    <div class="row text-center text-primary">
        <div class="col-12 text-right" > 
            ...
            <span class="badge bg-danger-400 badge-pill badge-float border-2 border-white" style="right:-.1rem;"><?=count($notif);?></span>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-11">
                        Upcoming Expired Procedure:<br/><span style="font-size:20px;"?><strong><?=$row->library;?></strong></span><br/>
                        <?=$row->judul;?><br/>
                        Rev No.<br/>
                        Rev Date:
                    </div>
