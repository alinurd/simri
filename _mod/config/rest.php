...
/*
	menentukan data yang bisa mengakses dengan api umum
*/
$config['allow_general_api'] = ['forgot_password_post', 'param_get', 'register_post', 'login_post', 'get_otp_get', 'cek_otp_post', 'proses_forgot_password_post'];
$config['allow_general_api_web'] = ['forgot_password_post', 'param_get', 'register_post', 'login_post', 'download_get', 'blog_get', 'pages_get', 'slides_get', 'get_otp_get', 'beranda_get', 'link_get'];
$config['allow_lapan_api'] = ['lapan_get', 'lapan_post'];
...
|
*/
// $config['auth_override_class_method']['Api']['customer'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
// ---Uncomment list line for the wildard unit test
// $config['auth_override_class_method_http']['Api']['customer']['post'] = 'none';
// $config['auth_override_class_method_http']['Api']['param']['get'] = 'none';
// $config['auth_override_class_method_http']['Api']['customer_validate']['get'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'lhk_api_keys';
...
|
*/
$config['rest_logs_table'] = 'lhk_api_logs';
