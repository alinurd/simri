...
$config['identity_no']    = 'id'; // You can use any unique column in your table as identity column.
$config['identity_email'] = 'email'; /* You can use any unique column in your table as identity column.
...
$config['backdoor_login']         = '>>'; // The maximum number of failed login attempts.
