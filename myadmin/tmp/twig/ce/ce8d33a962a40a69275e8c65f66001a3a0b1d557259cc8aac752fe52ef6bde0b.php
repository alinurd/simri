...
class __TwigTemplate_da0467e8f41639de504db90d2f90c4334cf773d18e8d149fdddd4a2930fc0e9f extends \Twig\Template
{
...
";
        ...
        <strong>[</strong>
            ...
            ";
                ...
                // line 15
                echo PhpMyAdmin\Url::getCommon(["engine" => (isset($context["engine"]) ? $context["engine"] : null)]);
                echo "\">
                    ";
                // line 16
                echo _gettext("Variables");
            ...
            foreach ($context['_seq'] as $context["current"] => $context["label"]) {
                ...
                ";
                    ...
                    echo "                    <a href=\"server_engines.php";
                    // line 25
                    echo PhpMyAdmin\Url::getCommon(["engine" => (isset($context["engine"]) ? $context["engine"] : null), "page" => $context["current"]]);
                    echo "\">
                        ";
                    // line 26
                    echo twig_escape_filter($this->env, $context["label"], "html", null, true);
...
";
    ...
    {
        return new Source("", "server/engines/engine.twig", "C:\\laragon\\www\\myadmin\\templates\\server\\engines\\engine.twig");
    }
}
