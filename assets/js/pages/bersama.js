...
function _ajax_(tipe, parent, data, target_combo, url, proses_result, sts_loading, tipe_result){
	url = base_url + url;
...
function _ajax_file_(tipe, parent, data, target_combo, url, proses_result, sts_loading, tipe_result) {
	url = base_url + url;
	data[csrf_token_name] = csrf_hash;
...
$(function() {
	...
	$(document).on('click','.detail-img', function() {
		...
		var img ='<div class="row"><div class="col-xl-12 text-center"><img src="'+url+'"></div></div>';
